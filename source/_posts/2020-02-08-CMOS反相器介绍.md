...
###### 电压传输特性（VTC）：
![电压传输特性](https://sliu0827.github.io/source/images/doc/数字集成电路基础/CMOS反相器介绍/fig1.png#pic_center "电压传输特性")

- PMOS的静态特性曲线可由镜像平移得到，观察两种MOS管的VTC曲线可得到CMOS反相器的传输特性
![CMOS反相器传输特性](https://sliu0827.github.io/source/images/doc/数字集成电路基础/CMOS反相器介绍/fig2.png#pic_center "CMOS反相器传输特性")
...
![反相器开关阈值变化](https://sliu0827.github.io/source/images/doc/数字集成电路基础/CMOS反相器介绍/fig3.png#pic_center "反相器开关阈值变化")
...
NMH = VDD - VIH , NML = VIL  
![噪声容限](https://sliu0827.github.io/source/images/doc/数字集成电路基础/CMOS反相器介绍/fig4.png#pic_center "噪声容限")
